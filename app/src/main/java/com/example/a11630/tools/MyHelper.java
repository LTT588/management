...
import com.example.a11630.domain.searcher;
...
//执行SQL语句
  ...
  public  void Insert(SQLiteDatabase db, String table, String name, String id) {   ///db,table,name,id
   ...
   /* public  void loginy(SQLiteDatabase db, String table, String message)
    {


        Cursor cursor = db.query("time_id", null,
                null, null, null, null, null);
        String sql="select * from"+table+"where"+message;
        db.execSQL(sql);
        cursor.moveToFirst();
   ...
   public  void Insert3(SQLiteDatabase db, String table, String userid,String name, String age,String xueli) {   ///db,table,name,age,xueli
    ...
    public void Delete3(SQLiteDatabase db, String table,String userid) {
        String sql = "delete from " + table + " where  userid=" +userid;
        System.out.println("sqi语句："+sql);
        db.execSQL(sql);
    }
    public void chaxun(SQLiteDatabase db, String table,String userid) {
